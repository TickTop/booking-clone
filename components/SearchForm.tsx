  ...
  return (
    ...
    space-y-4 lg:space-y-0 rounded-lg">
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className='flex text-white'>Location <BedDoubleIcon className='ml-2 h-4 w-4 text-white'/></FormLabel>
            <FormMessage />
            <FormControl>
      ...
      <div className="grid w-full lg:max-w-sm lg:flex-1 items-center gap-1.5">
      <FormField
        control={form.control}
        name="dates"
        render={({ field }) => (
          <FormItem className='flex flex-col'>
            <FormLabel className='flex text-white'>Dates </FormLabel>
            <FormMessage />
          <Popover>
